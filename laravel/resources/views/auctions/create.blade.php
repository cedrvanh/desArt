        ...
        <div class="card-body">
            <form method="POST" action="/auctions">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <label for="feature">Kenmerken</label>
                        <select class="form-control" name="feature" id="feature">
                            <option>Canvas</option>
                            <option>Eigen werk</option>
                            <option>Handgetekend</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label for="inputDimensions">Afmetingen</label>
                        <input class="form-control{{ $errors->has('dimensions') ? ' is-invalid' : '' }}" name="dimensions" id="inputDimensions">
